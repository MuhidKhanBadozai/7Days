        ...
        <div className="border p-5 rounded-md shadow-sm">
          ...
          <div className="flex flex-col items-start gap-2">
            ...
            <button
              ...
              className="bg-[#000000] text-white px-4 py-2 rounded hover:bg-[#000000] mt-2"
            >
              Filter
            </button>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {displayed.map((product) => (
                ...
                >
                  ...
                  <div 
                    className="text-sm font-medium text-gray-900 line-clamp-2 mb-1 cursor-pointer hover:text-[#000000] transition-colors"
                    onClick={() => navigate(`/product/${product.sku}`)}
                  >
                    {product.name}
                  </div>
