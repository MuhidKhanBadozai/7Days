        ...
        <div className="px-6 py-8 sm:p-10">
          ...
          <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
            <section>
              ...
              <p className="mb-6">
                Welcome to BrandMasters Wholesale. These terms and conditions outline the rules and 
                regulations for the use of our website and services. By accessing this website, we assume 
                you accept these terms and conditions in full. Do not continue to use BrandMasters Wholesale's 
            ...
            <section>
              ...
              <p className="mb-4">
                Unless otherwise stated, BrandMasters Wholesale and/or its licensors own the intellectual 
                property rights for all material on this website. All intellectual property rights are reserved. 
                You may access this from BrandMasters Wholesale for your own personal use subjected to 
                restrictions set in these terms and conditions.
              </p>
              <p className="mb-4">You must not:</p>
              <ul className="list-disc list-inside space-y-2 ml-6 mb-4">
                <li>Republish material from BrandMasters Wholesale</li>
                <li>Sell, rent, or sub-license material from BrandMasters Wholesale</li>
                <li>Reproduce, duplicate, or copy material from BrandMasters Wholesale</li>
                <li>Redistribute content from BrandMasters Wholesale</li>
                <li>Use any images, logos, or trademarks without express written permission</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-6 mb-4">
                ...
                <li>Immediately notifying us of any unauthorized use of your password or account</li>
            ...
            <section>
              ...
              <p className="mb-4">
                ...
                any products at any time. We reserve the right to refuse any order you place with us. 
              ...
              <p className="mb-4">
                We strive to display as accurately as possible the colors and images of our products that 
                appear at the store. We cannot guarantee that your computer monitor's display of any color 
                will be accurate.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="mb-4">
                All prices are shown in US Dollars and are subject to change without notice. We reserve 
              ...
              <p className="mb-4">
                ...
                all purchases made at our store. You agree to promptly update your account and other information, 
            ...
            <section>
              ...
              <p className="mb-4">
                We ship to addresses within the United States and selected international locations. Shipping 
                times and costs vary depending on your location and the shipping method selected. We are not 
                responsible for any delays caused by customs, weather conditions, or other unforeseen circumstances.
              </p>
              <p className="mb-4">
                Risk of loss and title for items purchased from this website pass to you upon delivery of 
                the items to the carrier. You are responsible for filing any claims with carriers for damaged 
            ...
            <section>
              ...
              <p className="mb-4">
                To the fullest extent permitted by applicable law, in no event shall BrandMasters Wholesale, 
