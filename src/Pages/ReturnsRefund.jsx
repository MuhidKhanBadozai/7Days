      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md overflow-hidden">
        <div className="px-6 py-8 sm:p-10">
          ...
          <div className="space-y-8 text-gray-700 text-lg leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Additional Non-Returnable Items</h2>
              <ul className="list-disc list-inside space-y-2 ml-6 mb-4">
                <li>Gift cards</li>
                <li>Bulk (50 units+) quantity orders</li>
                <li>Downloadable software products</li>
                <li>Some health and personal care items</li>
                <li>Customized or personalized products</li>
                <li>Items sold as part of a bundle or package deal</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-6 mb-4">
                ...
                <li>Bulk (50 units+) quantity orders with partial returns</li>
                <li>Items with damaged packaging that affects resale value</li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-gray-800 mb-4">Shipping Returns</h2>
              <p className="mb-4">
